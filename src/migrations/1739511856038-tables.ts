...
export class Tables1739511856038 implements MigrationInterface {
    name = 'Tables1739511856038'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "roles" text array NOT NULL DEFAULT ARRAY['user'`);
